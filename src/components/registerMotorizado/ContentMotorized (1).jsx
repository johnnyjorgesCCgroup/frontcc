    ...
    try {
      ...
      console.log("Aquiiii datosConZona", datosConZona);
        ...
        const estadoTotal = [
          ...
          { "status": 9, "indice": "INCIDENTE-ENTREGA" },
        ...
        const estadoTotalChange = [
          ...
          { "status": 9, "indice": "INCIDENTE-ENTREGA-CAMBIO" },
      ...
      const worksheet = XLSX.utils.aoa_to_sheet([['FECHA', 'SOLUCION', 'TIPO', 'CANAL', 'OC', 'ORIGEN', 'CLIENTE','TELEFONO',  'DOMICILIO', 'REFERENCIA', 'DISTRITO', 'PRODUCTO', 
