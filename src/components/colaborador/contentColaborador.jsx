...
export default function contentInventory() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const orderCountMonthVendedor1 = filteredData.reduce((count, item) => {
                    ...
                    if (itemDate >= startOfMonth && itemDate <= endOfMonth && item.user_id === 22) {
                        return count + 1;
                    } else {
                        return count;
                    }
    ...
    const columns = [
        ...
        {
            field: 'user_id', headerName: 'Asesor', flex: 0.5, 
                        ...
                        <div className="row mb-2" style={{ alignItems: "center" }}>
                            <div className="col-sm-6">
                                <h3 className="card-title">
                                    <b>Dashboard Ventas Colaborador</b>
                                </h3>
                ...
                <div className="principalCard">
                    <div className="vendedoresCard">
                        <div id="vendedorCard" className="card card-outline">
                            ...
                            <span id="vendedorText" className='info-box-text'>Contabilidad {orderCountMonthVendedor1}</span>
