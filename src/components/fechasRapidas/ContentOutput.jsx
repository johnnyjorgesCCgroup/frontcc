...
const ContentOutput = ({ incident }) => {

  const [ocValue, setOcValue] = useState(incident.oc);
    ...
    <Container >
      <Grid container spacing={2} alignItems="center">
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs={5} md={3}>
            <Button
              ...
              onClick={() => consultaOC(newProducto.oc)}
            >
            </Button>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs>
            <Button variant="contained" onClick={agregarProducto} startIcon={<FontAwesomeIcon icon={faPlus} />}>
               Agregar
            </Button>
          </Grid>
        </Grid>
